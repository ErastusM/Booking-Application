            ...
            <section style={{ paddingBottom: 'clamp(3rem, 7vh, 5rem)' }}>
                <div className="container" style={{ maxWidth: '700px', marginLeft: 'auto', marginRight: 'auto' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.75 }}>
                        <p>Bookplus started with a simple frustration: finding and booking a good local service in Namibia meant a string of phone calls, missed messages, and "just come in and we'll see." The people doing brilliant work — car washes, trainers, therapists, tutors, groomers — were often the hardest to actually reach.</p>

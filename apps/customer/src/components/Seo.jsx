...
const DEFAULT_DESC = 'Discover and book trusted local businesses — beauty, wellness, health, fitness, automotive and more. Real-time availability and instant confirmation.';

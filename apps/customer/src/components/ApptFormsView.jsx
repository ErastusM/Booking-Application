...
const ApptFormsView = ({ appointmentId }) => {
    ...
    return (
        <div style={{ background: 'var(--warm-gray)', borderRadius: 'var(--radius-sm)', padding: '1rem' }}>
            <p style={{ fontSize: '0.72rem', fontWeight: '600', color: 'var(--charcoal)', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: '0.75rem', fontFamily: 'var(--font-body)' }}>Forms</p>
                ...
                {forms.map(({ template, completed, submission }) => (
                    <div key={template._id}>
                        ...
                        >
                            ...
                            <span style={{ fontSize: '0.72rem', fontWeight: '600', padding: '0.15rem 0.55rem', borderRadius: '99px', background: completed ? '#d1fae5' : '#fef3c7', color: completed ? '#065f46' : '#92400e' }}>

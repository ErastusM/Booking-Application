...
// "Soon" marker for features that are switched off for now (FEATURES in
// @bookplus/config) — the wallet, while every client pays at the appointment.
const SoonBadge = () => (
...
const Navbar = () => {
    ...
    const navStyles = {
        ...
        background: isTransparent ? 'transparent' : darkMode ? '#0a0a0b' : '#ffffff',
        backdropFilter: 'none',
                                ...
                                <>
                                    ...
                                    <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 10px)', zIndex: 1101, width: '250px', background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '16px', boxShadow: '0 16px 44px rgba(4,5,5,0.20)', overflow: 'hidden', padding: '0.4rem' }}>
                                        ...
                                        {[
                                            ...
                                            { to: '/wallet', label: 'Wallet', soon: !FEATURES.walletEnabled, icon: <><rect x="2" y="6" width="20" height="13" rx="2"/><path d="M2 10h20M16 15h2"/></> },
            ...
            <>
                ...
                <aside className="show-mobile mobile-drawer" style={{
                    ...
                    <div style={{ flex: 1, padding: '0.6rem 0' }}>
                        ...
                        {user && mobileLink('/wallet', <>Wallet{!FEATURES.walletEnabled && <SoonBadge />}</>)}

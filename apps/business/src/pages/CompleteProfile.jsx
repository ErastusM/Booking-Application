...
// CompleteProfile, but this app is provider/admin-only, so it stays here
// and lands back on the provider dashboard instead of cross-app redirecting.
const CompleteProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(user?.role === 'admin' ? '/bkplus-command' : '/dashboard', { replace: true });
        } catch (err) {
                ...
                <div style={{ background: 'var(--card-bg)', borderRadius: 'var(--radius)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-md)', overflow: 'hidden' }}>
                    ...
                    <div style={{ padding: '2.5rem' }}>
                        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                            ...
                            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.8rem', fontWeight: '600', color: 'var(--charcoal)', marginBottom: '0.35rem' }}>
                                One last step!
                            </h1>

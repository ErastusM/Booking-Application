        ...
        await transporter.sendMail({
            ...
            <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #fafaf8;">
                <div style="background: #1a1a2e; padding: 2rem; text-align: center;">
                    <h1 style="font-family: Georgia, serif; color: #c9a84c; font-size: 1.8rem; margin: 0; letter-spacing: 0.05em;">Book<span style="color:white">plus</span></h1>
                    <p style="color: #9ca3af; font-size: 0.8rem; margin: 0.5rem 0 0; letter-spacing: 0.1em; text-transform: uppercase;">Suggestion Box</p>
                </div>
                <div style="padding: 2rem; background: white; border-left: 1px solid #e8e6e1; border-right: 1px solid #e8e6e1;">
                    ...
                    <h2 style="font-family: Georgia, serif; color: #1a1a2e; font-size: 1.35rem; margin: 0 0 1.5rem;">A new suggestion has been submitted</h2>
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
                        <tr style="border-bottom: 1px solid #f0ede8;">
                            ...
                            <td style="padding: 0.6rem 0; color: #1a1a2e;">${safeName}</td>
                        </tr>
                        <tr style="border-bottom: 1px solid #f0ede8;">
                            <td style="padding: 0.6rem 0; color: #6b7280; font-weight: 600;">Email</td>
                            <td style="padding: 0.6rem 0; color: #1a1a2e;">${safeEmail}</td>
                        </tr>
                        <tr>
                            <td style="padding: 0.6rem 0; color: #6b7280; font-weight: 600;">User type</td>
                            <td style="padding: 0.6rem 0; color: #1a1a2e; text-transform: capitalize;">${safeRole}</td>
                        </tr>
                    </table>
                    <div style="background: #fafaf8; border-left: 3px solid #c9a84c; padding: 1.25rem 1.5rem; border-radius: 0 8px 8px 0; margin-bottom: 1.5rem;">
                        <p style="color: #1a1a2e; font-size: 0.95rem; line-height: 1.75; margin: 0; white-space: pre-wrap;">${safeMessage}</p>
                    </div>
                ...
                <div style="background: #1a1a2e; padding: 1.25rem 2rem; text-align: center;">

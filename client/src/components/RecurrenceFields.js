...
const pill = (active) => ({
    padding: '0.45rem 0.95rem', borderRadius: '99px', cursor: 'pointer', fontFamily: 'Outfit, sans-serif',
                ...
                <div style={{ marginTop: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                    ...
                    {custom && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                            <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', fontFamily: 'Outfit, sans-serif' }}>Repeat every</span>

                    ...
                    {sent ? (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <textarea
                                ...
                                rows={6}
                                maxLength={2000}
                                style={{ width: '100%', boxSizing: 'border-box', padding: '0.875rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border)', fontFamily: 'Outfit, sans-serif', fontSize: '0.875rem', color: 'var(--charcoal)', resize: 'vertical', outline: 'none', lineHeight: 1.65 }}
                            />
                            ...
                            <button
                                type="submit"
                                disabled={submitting}
                                style={{ width: '100%', padding: '0.85rem', background: submitting ? '#9ca3af' : 'var(--charcoal)', color: 'white', border: 'none', borderRadius: 'var(--radius-sm)', fontFamily: 'Outfit, sans-serif', fontSize: '0.9rem', fontWeight: '700', cursor: submitting ? 'not-allowed' : 'pointer', letterSpacing: '0.03em', transition: 'background 0.15s' }}
                            >

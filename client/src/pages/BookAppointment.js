            ...
            <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
                ...
                <div style={{ background: 'var(--charcoal)', paddingTop: '9rem', paddingBottom: '3rem', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div className="container" style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        <button onClick={() => setStep('form')} style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 'var(--radius-sm)', padding: '0.5rem 1rem', color: 'white', cursor: 'pointer', fontSize: '0.85rem', fontFamily: 'Outfit, sans-serif' }}>← Back</button>
                        <div>
...
const BookAppointment = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await appointmentService.createAppointment({ ...formData, selectedAddOns });
            setSuccess('Appointment booked! You will receive a confirmation email shortly.');

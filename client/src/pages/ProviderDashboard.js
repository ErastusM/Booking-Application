        ...
        <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    backgroundImage: 'radial-gradient(ellipse at 70% 40%, rgba(201,168,76,0.1) 0%, transparent 60%)',
                    pointerEvents: 'none',
                }} />
            ...
            <div className="container" style={{ paddingTop: '2.5rem', paddingBottom: '5rem' }}>
                    ...
                    {tabs.map(tab => (
                        ...
                        >
                            ...
                            {counts[tab] > 0 && (
                                <span style={{
                                    marginLeft: '0.4rem',
                                    background: activeTab === tab ? 'var(--gold)' : 'var(--warm-gray)',
                                    color: activeTab === tab ? 'var(--charcoal)' : 'var(--text-muted)',
                ...
                {filtered.length === 0 ? (
                    <div style={{
                        ...
                        <p style={{
                            fontFamily: 'Playfair Display, serif',
                            fontSize: '1.1rem', color: 'var(--charcoal)', marginBottom: '0.35rem',
                        }}>
                            No {activeTab} appointments
                        </p>
                        <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
                            Check back later or switch tabs to see other bookings.
                        </p>
                    </div>
                ) : (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p style={{ fontFamily: 'Playfair Display, serif', fontWeight: '600', color: 'var(--charcoal)' }}>
                                            {a.customer?.name}
                                        </p>
                                    ...
                                    <div>
                                        ...
                                        <p style={{ color: 'var(--gold-dark)', fontWeight: '600', fontSize: '0.875rem' }}>
                                            ${a.service?.price} · {a.service?.duration} min
                                        </p>
                                    </div>
                                            ...
                                            <div style={{ display: 'flex', gap: '0.5rem' }}>
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        color: '#065f46', padding: '0.4rem 0.875rem',
                                                ...
                                                <button
                                                    ...
                                                    style={{
                                                        background: '#fee2e2', border: '1px solid #fca5a5',
                                                        color: '#ef4444', padding: '0.4rem 0.875rem',
                                                        borderRadius: 'var(--radius-sm)', cursor: 'pointer',
                                                        fontSize: '0.8rem', fontWeight: '600',
                                                        fontFamily: 'DM Sans, sans-serif',
                                                    }}
                                        ...
                                        {a.status === 'confirmed' && (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    color: '#1e40af', padding: '0.4rem 0.875rem',
                                                    borderRadius: 'var(--radius-sm)', cursor: 'pointer',
                                                    fontSize: '0.8rem', fontWeight: '600',
                                                    fontFamily: 'DM Sans, sans-serif',
                                                }}

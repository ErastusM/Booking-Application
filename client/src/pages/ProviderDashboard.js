...
import { appointmentService, availabilityService, providerServiceService, categoryService, blockedTimeService, clientCRMService, messageService, packageService, teamService, waitingListService, earningsService } from '../services';
...
const ProviderDashboard = () => {
    ...
    useEffect(() => {
        ...
        const validTabs = ['calendar', 'pending', 'confirmed', 'completed', 'cancelled', 'history', 'services', 'availability', 'overview', 'earnings', 'clients', 'messages', 'memberships', 'team'];
        ...
        <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
            ...
            <div className="container" style={{ paddingTop: '2.5rem', paddingBottom: '5rem' }}>
                ...
                <div className="tab-strip" style={{ display: 'flex', gap: '0.5rem', borderBottom: '1px solid var(--border)', marginBottom: '1.5rem', overflowX: 'auto', WebkitOverflowScrolling: 'touch', paddingBottom: '0.35rem' }}>
                    ...
                    {/* Other feature tabs */}
                    {[['services','✂️ Catalogue'],['availability','🗓 Availability'],['overview','📊 Overview'],['earnings','💵 Earnings'],['clients','👥 Clients'],['messages','💬 Messages'],['memberships','🪪 Memberships'],['team','👤 Team']].map(([tab, label]) => (
                        <button key={tab} onClick={() => setActiveTab(tab)} style={{
                            padding: '0.65rem 1rem', background: activeTab === tab ? 'rgba(201,168,76,0.1)' : 'white', border: '1px solid',
                            borderColor: activeTab === tab ? 'var(--gold)' : 'var(--border)',
                            borderRadius: '999px', color: activeTab === tab ? 'var(--gold-dark)' : 'var(--text-secondary)',
